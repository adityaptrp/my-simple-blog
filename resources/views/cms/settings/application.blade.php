...
@section('content')
    ...
    <div class="page-inner">
        {{-- Desc page --}}
        <h3 class="text-2.5xl text-gray-700">Setting Application</h3>
        <div class="flex flex-col sm:w-136">
            <span>You can update settings about this application like app name and auth setting, banner and others here.</span>
        </div>
